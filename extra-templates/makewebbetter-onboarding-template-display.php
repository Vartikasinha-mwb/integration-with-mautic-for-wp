	...
	<div class="mwb-onboarding-section">
		...
		<div class="mwb-on-boarding-wrapper">
			...
			<h3 class="mwb-on-boarding-heading">
				<?php esc_html_e( 'Welcome to MakeWebBetter', 'makewebbetter-mautic-for-wordpress' ); ?>
			</h3>
			<p class="mwb-on-boarding-desc">
				<?php esc_html_e( 'We love making new friends! Subscribe below and we promise to keep you up-to-date with our latest new plugins, updates, awesome deals and a few special offers.', 'makewebbetter-mautic-for-wordpress' ); ?>
			</p>
			<form action="#" method="post" class="mwb-on-boarding-form">
				...
				<div class="mwb-on-boarding-form-no_thanks">
					<a href="#" class="mwb-on-boarding-no_thanks"><?php esc_html_e( 'Skip For Now', 'makewebbetter-mautic-for-wordpress' ); ?></a>
				</div>
				</div>
			</form>
		</div>
