 ...
 * @subpackage MWB_Mautic_For_WP/public
 */
 ...
 */
class MWB_Mautic_For_WP_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/mwb-mautic-for-wp-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/mwb-mautic-for-wp-public.js', array( 'jquery' ), $this->version, false );
	...
	public function add_form_shortcode( $attr = array() ) {
		ob_start();
		require MWB_MAUTIC_FOR_WP_PATH . 'public/partials/forms.php';
