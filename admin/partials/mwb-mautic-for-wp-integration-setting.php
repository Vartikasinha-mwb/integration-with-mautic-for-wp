...
<div class="wrap">
	<div class="mwb-m4wp-admin-panel-head">
		<h3><?php esc_html_e( 'Integrations', 'makewebbetter-mautic-for-wordpress' ); ?></h3>
	</div>
	<div class="mwb-m4wp-admin-panel-main mwb-m4wp-admin-integration-panel">
	<div class="mwb-m4wp-admin-panel-back-wrap">
		<a href="?page=integrations"><?php esc_html_e( 'Back', 'makewebbetter-mautic-for-wordpress' ); ?></a>
	</div>
	<div class="mwb-m4wp-admin-form-wrap-title">
		<?php echo esc_attr( $integation->get_name() ); ?>
	</div>
			...
			<table class="form-table mwb-m4wp-admin-table">
				...
				<tr>
					...
					<td>
						...
						<!-- <option value="-1"><?php // esc_html_e( '--Select--', 'makewebbetter-mautic-for-wordpress' ) . ?></option> -->
