...
<div class="wrap">
	<div class="mwb-m4wp-admin-panel-head">
		<h3><?php esc_html_e( 'Dashboard', 'makewebbetter-mautic-for-wordpress' ); ?></h3>
	</div>
	<div class="mwb-m4wp-admin-panel-date">
		<form method="post">
			...
			<button type="submit" class="button"><?php esc_html_e( 'Apply', 'makewebbetter-mautic-for-wordpress' ); ?></button>
	...
	<div class="mwb-m4wp-admin-panel-main mwb-m4wp-admin-dashboard-panel">
		...
		<div class="mwb-m4wp-admin-widget-row">
			<div class="mwb-m4wp-admin-widget-head">
				<?php esc_html_e( 'Created Leads In Time', 'makewebbetter-mautic-for-wordpress' ); ?>
			</div>
		...
		<div class="mwb-m4wp-admin-widget-row">
			<div class="mwb-m4wp-admin-widget-head">
			<?php esc_html_e( 'Page Hits In Time', 'makewebbetter-mautic-for-wordpress' ); ?>
			</div>
		...
		<div class="mwb-m4wp-admin-widget-row">
			<div class="mwb-m4wp-admin-widget-head">
				<?php esc_html_e( 'Form Submissions In Time', 'makewebbetter-mautic-for-wordpress' ); ?>
			</div>
		...
		<?php if ( esc_attr( $top_lists ) ) : ?>
			<div class="mwb-m4wp-admin-widget-column">
				<div class="mwb-m4wp-admin-widget-head">
					<?php esc_html_e( 'Top Segments', 'makewebbetter-mautic-for-wordpress' ); ?>
				</div>
		...
		<?php if ( $top_creators ) : ?>
			<div class="mwb-m4wp-admin-widget-column">
				<div class="mwb-m4wp-admin-widget-head">
					<?php esc_html_e( 'Top Creators', 'makewebbetter-mautic-for-wordpress' ); ?>
				</div>
				<div id="top-lists" class="mwb-m4wp-admin-widget-wrap" data="<?php echo esc_attr( htmlspecialchars( json_encode( $top_lists['data'] ) ) ); ?>">
					<?php if ( count( $top_creators['data']['bodyItems'] ) > 0 ) : ?>
					<table id="top-lists-table" class="widget-table">
                        <tr><th><?php esc_html_e('Creator', 'mautic-for-wordpress') ?></th><th><?php esc_html_e('Contacts' , 'mautic-for-wordpress') ?></th></tr>
