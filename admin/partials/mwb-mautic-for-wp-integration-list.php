		...
		<table class="form-table mwb-m4wp-admin-table">
			...
			<tbody>
				...
				<tr integration="<?php echo esc_attr( $key ); ?>">
					...
					<td class="status">
						<label class="switch">
							<input type="checkbox" <?php checked( esc_attr( $integration->is_enabled() ), true ); ?> class="mwb-m4wp-enable-cb">
							<span class="slider round"></span>
						</label>
					</td>
					<td class="setting">
						<a href="?page=integrations&id=<?php echo esc_attr( $integration->get_id() ); ?>">
